...
```json
{
  ...
  "agentWorkflow": [
    ...
    "6. privacy-pools flow ragequit [workflowId|latest] --agent  (if the saved workflow is declined or the operator intentionally stops waiting)",
