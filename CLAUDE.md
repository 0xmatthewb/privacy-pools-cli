...
Default isolated suites are intentionally enumerated in `scripts/test-suite-manifest.mjs`; there are 19 as of v2.0.0. Coverage-only isolation keeps its own explicit list in the same manifest.
