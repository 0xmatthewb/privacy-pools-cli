/**
 * Fetches upstream source files from the public GitHub repos used as the
 * CLI's source of truth.
 *
 * Set CONFORMANCE_UPSTREAM_REF to override the upstream ref (defaults to
 * the current public `main` branch for every repo).
 */
