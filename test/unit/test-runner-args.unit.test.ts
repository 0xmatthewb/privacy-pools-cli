...
describe("test runner arg helpers", () => {
  ...
  test("coverage isolation keeps only the final documented superset", () => {
    expect(COVERAGE_ISOLATED_SUITES.map((suite) => suite.label)).toEqual([
      ...
      "workflow-backup-paths",
      "workflow-backup-write",
      "account-readonly-accounts-coverage",
      "account-readonly-sync-coverage",
      "account-readonly-migrate-coverage",
      "init-interactive-cancel-and-invalid-coverage",
      "init-interactive-generate-coverage",
      "init-interactive-import-coverage",
      "init-command-handler",
      "ragequit-handler-entry-and-submit-coverage",
      "ragequit-handler-unsigned-coverage",
      "ragequit-handler-ownership-coverage",
      "ragequit-handler-human-and-confirmation-coverage",
      "bootstrap-runtime",
      "launcher-runtime",
    ]);
  });
