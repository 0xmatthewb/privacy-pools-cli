    ...
    if (existsSync(lockPath)) {
        try {
            ...
            if (!isNaN(pid) && pid > 0 && isProcessAlive(pid) && pid !== process.pid) {
                throw new CLIError("Another privacy-pools operation is in progress.", "INPUT", "Wait for it to finish, or remove the lock file if the process is stuck: " + lockPath);
            }
