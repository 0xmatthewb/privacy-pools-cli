...
async function relayerFetch(chainConfig, path, options) {
    ...
    if (!res.ok) {
        ...
        throw new CLIError(`Relayer request failed: ${message}`, "RELAYER", "Check your network connection and try again. If it persists, the relayer may be temporarily down.");
    }
    return res;
}
